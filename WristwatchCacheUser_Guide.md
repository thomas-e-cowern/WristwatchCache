...
1. Tap **Change Watch** (or the watch card if nothing is selected)
2. Browse the list, or use the search bar to find a watch by brand or model
3. Tap any watch to log it as today's wear

**Let the app pick for you:**
Tap the **dice icon** to use the Smart Random Picker:
1. Choose a filter type — **Style** or **Movement**
2. Select a specific style (e.g., Diver) or movement type (e.g., Automatic)
3. The app picks a random **Available** watch matching that criteria
4. Tap **Wear This Watch** to confirm, or **Pick Again** to get another suggestion
...
**Adding a watch:**
Tap the **+** button. Fill in the required fields (brand and model) and any optional details:
...
**Viewing and editing a watch:**
Tap any watch in the list to open its detail view. Tap **Edit** to update any field.

**Deleting a watch:**
In the detail view, scroll to the bottom and tap **Delete Watch**. Confirm in the dialog. This also removes any special occasions linked to that watch.
...
1. Tap **+** on the Special Occasions tab
2. Enter a name (e.g., "Blue Watch Monday")
...
5. Optionally link a specific watch from your collection
6. Add any notes

**Viewing occasions:**
Occasions are sorted by next occurrence, soonest first. For recurring occasions, the **Next:** date is calculated automatically.

**Editing or deleting:**
Tap an occasion to edit it, or swipe left on any occasion to delete it.
...
- Use **Status** fields (In Service, Needs Service, etc.) to stay on top of maintenance without cluttering your active rotation.
